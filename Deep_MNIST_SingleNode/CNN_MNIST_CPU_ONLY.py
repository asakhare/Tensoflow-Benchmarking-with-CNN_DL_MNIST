...
config = tf.ConfigProto(log_device_placement=True,device_count={"CPU": num_cores})
config.intra_op_parallelism_threads = num_tasks
config.inter_op_parallelism_threads = num_tasks
print("Number of CPU Cores = " + str(num_cores))
os.environ["KMP_BLOCKTIME"]=str(30)
